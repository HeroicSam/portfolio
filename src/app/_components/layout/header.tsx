...
export default function Header() {
  ...
  return (
    <header className="fixed w-full h-[100px] flex justify-center bg-transparent px-6 md:px-20 lg:px-6 top-0 rounded-lg text-[#252525] dark:text-slate-100 z-50 backdrop-blur-sm">
